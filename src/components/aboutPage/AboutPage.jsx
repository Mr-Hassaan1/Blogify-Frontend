import aboutImg from "@/assets/images/About-blog.avif";
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <p className=" text-lg mb-4">
              Welcome to our Blogify Website! We created this platform for
              readers, writers, and thinkers to connect through stories,
              tutorials, and creative insights. Whether you're a passionate
              blogger or someone who loves reading, this space is built for you.
            </p>
            <p className=" text-lg mb-4">
