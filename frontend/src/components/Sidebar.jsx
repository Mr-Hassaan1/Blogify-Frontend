    ...
    <div className="hidden mt-10 fixed md:block border-r-2 dark:bg-gray-800 bg-gray-200 border-gray-300 dark:border-gray-600 0 w-75 p-10 space-y-2 h-screen z-10">
      <div className="text-center pt-10 px-3 space-y-2">
        <NavLink
          ...
          className={({ isActive }) =>
            `text-2xl  ${isActive ? "bg-gray-800 text-gray-200 dark:bg-gray-200 dark:text-gray-900" : "bg-transparent"} flex items-center gap-2 font-bold cursor-pointer p-2 rounded-2xl w-ful`
          }
        >
          <SquareUser />
          <span>Profile</span>
